...
// Google OAuth Strategy (only initialize if configured)
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_ID !== 'your_google_client_id_here') {
  ...
  console.log('ℹ️ Google OAuth not configured - skipping strategy initialization');
}

// GitHub OAuth Strategy (only initialize if configured)
if (process.env.GITHUB_CLIENT_ID && process.env.GITHUB_CLIENT_ID !== 'your_github_client_id_here') {
  ...
  console.log('ℹ️ GitHub OAuth not configured - skipping strategy initialization');
}
